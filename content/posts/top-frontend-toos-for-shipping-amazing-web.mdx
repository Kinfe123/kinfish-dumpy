...
[**DaisyUI**](https://daisyui.com/) - i dont like it personally , tailwinded bootstrap kind of it ,  but it deos a good job on locking you to it , but it is the most popular one fam , using semantic class name instead of tailwindcss becuase of the thing fewer classanme , fast dev , small bundle size
<Image
  width="1000"
  height="1000"
  alt="Image"
